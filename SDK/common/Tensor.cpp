...
int Tensor::count(int start_axis) const { return 0; }

Tensor &Tensor::to_half() { return <#initializer #>; }

Tensor &Tensor::to_float() { return <#initializer #>; }

Tensor &Tensor::to_cpu(bool copy) { return <#initializer #>; }

const char *Tensor::descriptor() const { return nullptr; }

void Tensor::reference_data(const std::vector<int> &shape, void *cpu_data,
                            size_t cpu_size, void *gpu_data, size_t gpu_size,
                            DataType d_type) {}

Tensor &Tensor::compute_shape_string() { return <#initializer #>; }
